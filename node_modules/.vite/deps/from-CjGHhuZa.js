import { n as __esmMin, t as __commonJSMin } from "./chunk-D9B2Ntkf.js";
import { n as require_browser_external_buffer } from "./googleapis.js";
...
var require_streams = /* @__PURE__ */ __commonJSMin((() => {
	...
	try {
		const { Blob } = require_browser_external_buffer();
...
})), import_browser_external_node_fs, stat;
var init_from = __esmMin((() => {
	import_browser_external_node_fs = require_browser_external_node_fs();
	require_browser_external_node_path();
	require_node_domexception();
	init_file();
	init_fetch_blob();
	({stat} = import_browser_external_node_fs.promises);
}));
//#endregion
...
//# sourceMappingURL=from-CjGHhuZa.js.map